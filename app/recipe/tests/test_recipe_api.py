...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_partial_update_recipe(self):
        ...
        payload = {'title': 'chicken tick', 'tags': [new_tag.id]}
        url = detail_url(recipe.id)
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='Aurbergine with tahini')
        tag1 = sample_tag(user=self.user, name='Vegan')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Chicken meal')
        recipe2 = sample_recipe(user=self.user, title='Beef meal')
        ...
        recipe3 = sample_recipe(user=self.user, title='tomato jem')
